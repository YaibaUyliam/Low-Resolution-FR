...
model = InceptionResnetV1(classify=True, num_classes=10572).to('cuda:0')
model.load_state_dict(torch.load('/home/crist_tienngoc/TOMO/fr/train_teacher/weights/weight_9'))
